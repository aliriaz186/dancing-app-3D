    ...
    <div id="main-carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item active">
                <img src="{{asset('img/dance_img/bbb.jpg')}}" class="bg-cover-img" alt="" style="width: 100%;height: auto;"/>
                <div class="container">
            ...
            <!-- BEGIN item -->
            <div class="item">
                <img src="{{asset('img/dance_img/life.jpg')}}" class="bg-cover-img" alt=""  style="width: 100%;height: auto;"/>
                <div class="container">
            ...
            <!-- BEGIN item -->
            <div class="item">
                <img src="{{asset('img/dance_img/Swirl.jpg')}}" class="bg-cover-img" alt="" style="width: 100%;height: auto;"/>
                <div class="container">
