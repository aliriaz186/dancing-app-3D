                ...
                <div class="header-container">
                    ...
                    <div class="header-nav" >
                        <div class=" collapse navbar-collapse" id="navbar-collapse"  >
                            <ul class="nav">
                                <li style="font-size: 13px;" id="home"><a href="{{ url('/') }}">Home</a></li>
                                <li style="font-size: 13px;" id="about" class="dropdown dropdown-hover">
                                    ...
                                    <ul class="dropdown-menu" style="background:#333333">
                                        <li><a href="{{ url('/about') }}" style="color:#ffffff">Features</a></li>
                                        <li><a href="{{ url('/about') }}" style="color:#ffffff">Summary</a></li>
                                        <li><a href="{{ url('/about') }}" style="color:#ffffff">User Testimonials</a></li>
                                        <li><a href="{{ url('/about') }}" style="color:#ffffff">Management Team</a></li>
                                    </ul>
                                </li>
                                <li  style="font-size: 13px;" id="dance_floor"><a href="{{ url('/side_view') }}">Dance Floor</a></li>
                                <li style="font-size: 13px;" id="dance_chart"><a href="{{ url('/chart') }}">Dance Chart</a></li>
                                <li style="font-size: 13px;" id="contact_us"><a href="{{ url('/contact') }}">Contact Us</a></li>
                                <li style="font-size: 13px;" id="lesson"><a href="{{ url('/select') }}">Lessons</a></li>
                                ...
                                <li style="font-size: 13px;" id="support" class="dropdown dropdown-hover">
                                    ...
                                    <ul class="dropdown-menu" style="background:#333333">
                                        ...
                                        <li><a href="{{url('/faq')}}" style="color:#ffffff">FAQ's</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="header-nav">
                        <ul class="nav pull-right">
                            <li class="dropdown dropdown-hover">
                                ...
                                <ul class="dropdown-menu" style="background:#333333">
                                    <li><a href="{{url('/profile',['id'=>Auth::user()->id])}}" style="color:#ffffff">Profile</a></li>
                                    <li><a href="{{url('/badge')}}" style="color:#ffffff">Badges</a></li>
                                    <li><a href="{{url('/notifications')}}" style="color:#ffffff">Notifications</a></li>
                                </ul>
