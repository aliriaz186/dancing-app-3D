...
<!--     This is the main view     -->
                        <div class="tab-pane fade active in" id="multi-view">
						  ...
						  <form class="col s8 offset-s2">
							...
							<img id="speak" src="{{asset('img/dance_img/play.png')}}" alt="" style="z-index: 100;display: block;margin-left: auto;margin-right: auto;"/>
							</form>
                            ...
                            <div class="row row-space-30">
								...
								<div class="col-md-5" style="border:1px; border-style:solid; border-color:#000000; padding: 1em;background: #ffffff;">
									...
									<form class="col s8 offset-s2">
										...
										<img id="speak2" src="{{asset('img/dance_img/play.png')}}" alt="" style="z-index: 100;display: block;margin-left: auto;margin-right: auto;"/>
									</form>
                            ...
                            <div class="row row-space-30">
								...
								<div class="col-md-5" style="border:1px; border-style:solid; border-color:#000000; padding: 1em;background: #ffffff;">
									...
									<form class="col s8 offset-s2">
										...
										<img id="speak3" src="{{asset('img/dance_img/play.png')}}" alt="" style="z-index: 100;display: block;margin-left: auto;margin-right: auto;"/>
									</form>
                            ...
                            <div class="row row-space-30">
								...
								<div class="col-md-5" style="border:1px; border-style:solid; border-color:#000000; padding: 1em;background: #ffffff;">
									...
									<form class="col s8 offset-s2">
										...
										<img id="speak4" src="{{asset('img/dance_img/play.png')}}" alt="" style="z-index: 100;display: block;margin-left: auto;margin-right: auto;"/>
									</form>
                            ...
                            <div class="row row-space-30">
								...
								<div class="col-md-5" style="border:1px; border-style:solid; border-color:#000000; padding: 1em;background: #ffffff;">
									...
									<form class="col s8 offset-s2">
										...
										<img id="speak5" src="{{asset('img/dance_img/play.png')}}" alt="" style="z-index: 100;display: block;margin-left: auto;margin-right: auto;"/>
									</form>
