                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul style="list-style: none;color: #fff;" >
                                <li>
                                    <img src="{{asset('img/dance_img/badge.png')}}" width="100px" alt="badge" />  <a href="#modal-alert" data-toggle="modal" style="color: #fff">Lesson 1 </a>
                                </li>
                                <li>
                                    <img src="{{asset('img/dance_img/badge.png')}}" width="100px" alt="badge" />  <a href="#modal-alert" data-toggle="modal" style="color: #fff">Lesson 1 </a>
                                </li>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content" style="background: #ffffff;">
                                ...
                                <div class="modal-body">
                                    <img src="{{asset('img/dance_img/badge.png')}}" width="300px" style="margin-left: 25%;"/>
                                </div>
                                <div class="modal-footer" style="text-align: center;">
                                    <img src="{{asset('img/dance_img/share-on-facebook.png')}}"  width="200px" /><img src="{{asset('img/dance_img/twitter_button.png')}}" width="200px" />
                            </div>
                        </div>
                    </div>
