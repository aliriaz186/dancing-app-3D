...
<body>
    ...
    <div id="page-container" class="fade">
        ...
        <!-- BEGIN #header -->
        <div id="header" class="header sticy-header">
            <!-- BEGIN container -->
            <div class="container">
                    ...
                    <div class="header-nav">
                        <div class=" collapse navbar-collapse" id="navbar-collapse">
                            <ul class="nav">
                                ...
                                <li><a href="{{ url('/guide') }}">Guided Tour</a></li>
                                <li class="dropdown dropdown-hover">
                                ...
                                <li><a href="{{ url('/chart') }}">Dance Chart</a></li>
                      ...
                      <ul class="nav pull-right">
                            <li class="dropdown dropdown-hover">
                                <a href="#modal-alert" class="header-cart"  data-toggle="modal">
                                    <span style="color:#b5b102;"> BUY NOW</span>
                                </a>
        ...
        <div id="footer-copyright" class="footer-copyright">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div style="margin-left: 50%;">All rights reserved.</div>
                </div>
            </div>
            <!-- END container -->
        </div>
