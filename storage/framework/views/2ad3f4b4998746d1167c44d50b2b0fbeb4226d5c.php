    ...
    <div id="main-carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item active">
                <img src="<?php echo e(asset('img/dance_img/bbb.jpg')); ?>" class="bg-cover-img" alt="" style="width: 100%;height: auto;"/>
                <div class="container">
                    <img src="<?php echo e(asset('img/dance_img/slide2_dance.png')); ?>" class="product-img right bottom fadeInRight animated" alt="" />
                </div>
                <div class="container" style="margin-right: 0%;margin-top: 4%;">
                    ...
                    <a href="https://www.youtube.com"  target="_blank"> <img src="<?php echo e(asset('img/dance_img/play.png')); ?>" class="product-img right bottom fadeInRight animated" alt="" style="z-index: 100;"/></a>
                </div>
                <div class="carousel-caption carousel-caption-left">
                    <div class="container">
                        ...
                        <a href="<?php echo e(url('/guide')); ?>" class="btn btn-outline btn-lg fadeInLeftBig animated">Take Tour</a>
                    </div>
                </div>
            </div>
            <!-- END item -->
            <!-- BEGIN item -->
            <div class="item">
                <img src="<?php echo e(asset('img/dance_img/life.jpg')); ?>" class="bg-cover-img" alt=""  style="width: 100%;height: auto;"/>
                <div class="container">
                    <img src="<?php echo e(asset('img/dance_img/slide4_dance.png')); ?>" class="product-img left bottom fadeInLeft animated" alt="" />
                </div>
                <div class="carousel-caption carousel-caption-right">
                    <div class="container">
            ...
            <!-- BEGIN item -->
            <div class="item">
                <img src="<?php echo e(asset('img/dance_img/Swirl.jpg')); ?>" class="bg-cover-img" alt="" style="width: 100%;height: auto;"/>
                <div class="container">
                    <img src="<?php echo e(asset('img/dance_img/slide3_dance.png')); ?>" class="product-img left bottom fadeInLeft animated" alt="" />
                </div>
...
</div><?php /**PATH C:\xampp\htdocs\dancing-app-3D\resources\views//_slider.blade.php ENDPATH**/ ?>