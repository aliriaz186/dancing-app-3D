                        ...
                        <div class="col-md-6">
                            <div class="form-group has-feedback">
                                ...
                                <span class="invalid-feedback">
                                    <strong
                                        style="color:red"><?php echo e($errors->first('username') ?: $errors->first('email')); ?></strong>
                                </span>
                                <?php endif; ?>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dancing-app-3D\resources\views/login.blade.php ENDPATH**/ ?>